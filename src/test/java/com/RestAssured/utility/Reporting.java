...
//Listener used to generate reports
import java.io.File;
...
public class Reporting extends TestListenerAdapter{
	...
	public void onStart(ITestContext testContext)
	{
		...
		htmlReporter.config().setDocumentTitle("RestAssured Automation Test Project");//Title of report
		htmlReporter.config().setReportName("Rest API Test Report");//name of the report
